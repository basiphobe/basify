...
from .py.timer_display import NODE_CLASS_MAPPINGS as timer_display_nodes
from .py.timer_display import NODE_DISPLAY_NAME_MAPPINGS as timer_display_display
